    ...
    return (
        <main className="min-h-screen bg-background text-foreground relative transition-colors duration-500">
            ...
            <section className="relative pt-32 pb-20 px-6 overflow-hidden">
                {/* Background Glows */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-blue-600/10 dark:bg-blue-600/20 blur-[150px] -z-10 rounded-full" />

                <div className="max-w-7xl mx-auto text-center space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel border-foreground/10 text-[10px] font-black uppercase tracking-widest text-blue-500 dark:text-blue-400 mb-4 shadow-xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-12 pb-12">
                        <Link href="/planners">
                            <Button size="lg" className="px-10 h-16 rounded-2xl bg-foreground text-background hover:opacity-90 shadow-2xl shadow-foreground/10 flex items-center gap-2 group">
                        ...
                        <Link href="/auth/register-planner">
                            <Button variant="glass" size="lg" className="px-10 h-16 rounded-2xl border-foreground/10 hover:border-foreground/30 backdrop-blur-xl">
                                Join as a Planner
                            </Button>
                        </Link>
                    </div>
            ...
            <section className="max-w-7xl mx-auto px-6 py-24 space-y-16">
                <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-foreground/5 pb-10">
                    <div className="space-y-2 text-center md:text-left">
                        <h2 className="text-3xl font-black tracking-tighter text-foreground">Featured Specialists</h2>
                        <p className="text-muted-foreground font-light">The highest-rated professionals on our platform today.</p>
                    </div>
                    <Link href="/planners">
                        <Button variant="outline" className="rounded-xl border-foreground/5 hover:border-foreground/20">View All Professionals</Button>
                    </Link>
                </div>
            ...
            <section className="bg-foreground/[0.02] border-y border-foreground/5">
                <div className="max-w-7xl mx-auto px-6 py-24 space-y-16">
                    <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-foreground/5 pb-10">
                        ...
                        <Link href="/events">
                            <Button variant="outline" className="rounded-xl border-foreground/5 hover:border-foreground/20">Explore Gallery</Button>
                        </Link>
                    </div>
            ...
            <section className="max-w-7xl mx-auto px-6 py-32 grid grid-cols-1 lg:grid-cols-3 gap-12">
                {[
                    ...
                    <div key={i} className="space-y-4 p-8 glass-panel border-foreground/5 rounded-[2.5rem] hover:border-foreground/10 transition-all hover:-translate-y-2 duration-500">
                ...
                <div className="fixed top-24 left-1/2 -translate-x-1/2 z-50 w-full max-w-md animate-in fade-in slide-in-from-top-4 duration-500">
                    <div className="mx-4 p-4 glass-panel border-red-500/20 bg-red-500/10 flex items-start gap-4 shadow-2xl shadow-red-500/10">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-foreground/70 mt-1">{authError}</p>
                        </div>
                        <button
